...
},{"./store.js":"leR5x"}],"leR5x":[function(require,module,exports,__globalThis) {
...
class Store {
    ...
    saveToStorage() {
        try {
            if (this.state.selectedGoal) localStorage.setItem('onboarding_goal', this.state.selectedGoal);
        } catch  {
        // молча
        }
    }
    ...
    getGoalInputs() {
        return [
            ...this.root.querySelectorAll('input.choice__input[name="goal"]')
        ];
    }
    goalLabel(value) {
        return (0, _dataJs.GOALS).find((g)=>g.value === value)?.label || value;
    }
    syncUI() {
...
},{"./data.js":"iu8CL","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iu8CL":[function(require,module,exports,__globalThis) {
// ./scripts/onboarding/data.js
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "GOALS", ()=>GOALS);
const GOALS = [
    {
        value: 'travel',
...
},{}]},["lWNPT","xsde0"], "xsde0", "parcelRequire3a13", {})
