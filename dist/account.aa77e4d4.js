...
})({"9qz36":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d055fa5eaa77e4d4";
"use strict";
...
},{}],"2Idbs":[function(require,module,exports,__globalThis) {
var _storeJs = require("./store.js");
const store = new (0, _storeJs.Store)(document);
document.addEventListener('DOMContentLoaded', ()=>store.init());

},{"./store.js":"5B5sy"}],"5B5sy":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Store", ()=>Store);
var _routerJs = require("../common/router.js");
var _stateJs = require("../common/state.js");
var _uiJs = require("../common/ui.js");
class Store {
    root;
    state;
    box;
    constructor(root){
        this.root = root;
        this.state = (0, _stateJs.loadState)();
        this.box = null;
    }
    init() {
        (0, _routerJs.wireBackButton)('onboarding');
        (0, _uiJs.setProgress)(100);
        this.box = (0, _uiJs.ensureMessageBox)(this.root.querySelector('main.content') || this.root.body);
        this.fillFromState();
        this.bindEvents();
        this.syncButtonText();
    }
    getInputs() {
        const inputs = [
            ...this.root.querySelectorAll('.group .input')
        ];
    ...
    fillFromState() {
        ...
        const switches = [
            ...this.root.querySelectorAll('.group--switches .switch-row')
        ];
        const map = [
            {
                key: 'sound',
    ...
    validateProfile(profile) {
        ...
        if (profile.email.trim() && !emailOk) return {
            ok: false,
            message: 'Email looks incorrect'
        };
        if (missing.length) return {
            ok: false,
            message: `Empty fields: ${missing.join(', ')}`
        };
        return {
            ok: true,
            message: 'Thank you'
    ...
    bindEvents() {
        ...
        const onAnyInput = ()=>{
            if (this.box) (0, _uiJs.hideMessage)(this.box);
        };
        ...
        for (const row of switches){
            ...
            input.addEventListener('change', ()=>{
                ...
                const key = label.includes('Sound') ? 'sound' : label.includes('Animations') ? 'animations' : label.includes('Motivational') ? 'motivational' : 'listening';
                this.state = (0, _stateJs.updateState)({
                    settings: {
                        [key]: input.checked
                    }
                });
        ...
        if (btn) btn.addEventListener('click', ()=>{
            ...
            if (this.box) (0, _uiJs.showMessage)(this.box, check.message, check.ok ? 'ok' : 'warn');
            if (!check.ok) return;
            this.state = (0, _stateJs.updateState)({
                profile,
                auth: {
            ...
            this.syncButtonText();
            setTimeout(()=>(0, _routerJs.go)('dashboard'), 600);
        });
        if (logout) logout.addEventListener('click', (e)=>{
            ...
            this.syncButtonText();
            if (this.box) (0, _uiJs.showMessage)(this.box, 'Logged out', 'info');
            (0, _routerJs.go)('landing');
        });
        if (del) del.addEventListener('click', (e)=>{
            e.preventDefault();
            const ok = window.confirm('Delete account?');
            if (!ok) return;
            (0, _stateJs.resetState)();
            (0, _routerJs.go)('landing');
        });
    }
}

},{"../common/router.js":"6h3nx","../common/state.js":"dfD6B","../common/ui.js":"8HP2B","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"6h3nx":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "go", ()=>go);
parcelHelpers.export(exports, "currentPage", ()=>currentPage);
parcelHelpers.export(exports, "wireBackButton", ()=>wireBackButton);
const PAGES = new Set([
    'landing',
    'onboarding',
    'account',
...
const wireBackButton = (fallback = 'landing')=>{
...
},{}],"dfD6B":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DEFAULT_STATE", ()=>DEFAULT_STATE);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8HP2B":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ensureMessageBox", ()=>ensureMessageBox);
parcelHelpers.export(exports, "showMessage", ()=>showMessage);
parcelHelpers.export(exports, "hideMessage", ()=>hideMessage);
parcelHelpers.export(exports, "setProgress", ()=>setProgress);
const ensureMessageBox = (root)=>{
...
const showMessage = (box, text, kind = 'info')=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["9qz36","2Idbs"], "2Idbs", "parcelRequire3a13", {})

//# sourceMappingURL=account.aa77e4d4.js.map
